		...
		function _init() {
			...
			if( is_admin() && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == ESA_OPTIONS_PAGE ) {
				if( function_exists( 'wp_register_style' ) ) {
					wp_register_style( 'esa_admin_styles', plugins_url( 'css/extended_super_admins.css', __FILE__ ), array(), '0.6.1', 'all' );
				}
				if( function_exists( 'wp_register_script' ) ) {
					wp_register_script( 'esa_admin_scripts', plugins_url( 'scripts/extended_super_admins.js', __FILE__ ), array('jquery','post'), '0.6.1', true );
				}
